...
const MiniCard = (props) => {
  ...
  const [landscapeOrientationSDuo] = useMediaQuery(
  ...
  return (
    <Flex
      ...
      flexDirection={[
        landscapeOrientationSDuo ? "column" : "row",
        "row",
        "column",
      ]}
      alignItems="center"
    ...
    >
      <Box textAlign="center" alignContent="center" width="6ex">
        ...
        <Text
          display={
            isSurfaceDuo
              ? "none"
              : { base: "none", sm: "block", md: "none", lg: "none" }
          }
          fontSize={["1.2ex"]}
          fontWeight="normal"
          padding={0}
      ...
      <Box paddingLeft={isPhoneDisplay || isSurfaceDuo ? "0ex" : "0px"}>
        <Text fontSize={["16px"]}>
